...
import sys
OUT_PATH = Path(sys.argv[1]) if len(sys.argv) > 1 else REPO_ROOT / "content" / "2026-08-24-lunes-roast" / "imagen-post.png"
...
# ------------------------------------------------------------
PANEL_TAG = "ROAST SEO · ECOMMERCE"   # etiqueta pequeña arriba (tema del día)
STAT_NUMBER = "3.000"                        # cifra grande de impacto (titular visual)
STAT_LABEL = "URLs de búsqueda interna indexadas por Google sin querer"
TITLE_LINE1 = "TU BUSCADOR INTERNO"
TITLE_LINE2 = "SABOTEA TU SEO"
